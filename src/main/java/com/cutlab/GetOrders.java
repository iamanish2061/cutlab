...
public class GetOrders extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		try {
			int totalInCart = db.getTotalCartItems(userId);
			jsonResponse.put("cartTotal", totalInCart);
			
			int totalOrders = db.getTotalOrders(userId);
			jsonResponse.put("orderTotal", totalOrders);
			
			Object orders = db.getOrders(userId);
